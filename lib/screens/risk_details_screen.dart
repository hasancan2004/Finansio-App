      ...
      body: Column(
        children: [
          Padding(
            ...
            child: AppHeader(
              title: "Risk Detay 🧠",
              subtitle: "Tahmin + limit + bütçelerden hesaplanır",
          ...
          Expanded(
            child: ListView(
              ...
              children: [
                ...
                // 2) BREAKDOWN: Forecast / Global Limit / Kategori Bütçeleri
                Card(
                  color: cs.primaryContainer.withOpacity(0.22),
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(18),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        forecastAsync.when(
                          loading: () => _loadingLine(theme, "Forecast yükleniyor…"),
                          error: (e, st) => _errorLine(theme, cs, "Forecast hatası: $e"),
                          data: (f) {
                            final netColor =
                            f.predictedNetMonth >= 0 ? Colors.green : cs.error;

                            return Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                _BreakdownRow(
                                  title: "Forecast (Ay sonu)",
                                  valueText: currency.format(f.predictedNetMonth),
                                  color: netColor,
                                  subtitle:
                                  "Gelir: ${currency.format(f.predictedIncomeMonth)} • Gider: ${currency.format(f.predictedExpenseMonth)}",
                                ),
                        ...
                        budgetsAsync.when(
                          ...
                          data: (list) {
                            ...
                            // ✅ “en riskli kategori” (exceeded varsa oradan, yoksa near’dan)
    ...
    switch (level) {
      ...
      case RiskLevel.low:
        return const [
          ...
          "Tahmin kartını ara ara kontrol edip sürpriz giderlere hazır ol.",
        ];
    }
  }
}
