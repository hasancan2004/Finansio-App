...
import 'package:finansio/screens/filtered_tx_list_screen.dart';
import 'package:finansio/screens/risk_details_screen.dart';
import 'package:finansio/providers/risk_providers.dart';
...
import 'package:finansio/providers/reports.dart';
...
import 'package:finansio/services/pdf_export_service.dart';
          ...
          Padding(
            ...
            child: AppHeader(
              ...
              trailing: Row(
                ...
                children: [
                  // 1. İNDİR BUTONU (Gerçek hesaplama + Sistem Bildirimi)
                  Material(
                    ...
                    child: InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (transactions.isNotEmpty) {
                          // ✅ 0.00 TL Sorununu Çözen Anlık Hesaplama
                          ...
                          // İndirme işlemini başlat ve dosya yolunu al
                          ...
                          // İndirme başarılıysa GERÇEK SİSTEM BİLDİRİMİ gönder
                          if (filePath != null) {
                  ...
                  // 2. MEVCUT PAYLAŞ BUTONU (Aynı hesaplama buraya da eklendi)
                  Material(
                    color: Colors.transparent,
                    child: InkWell(
                      borderRadius: BorderRadius.circular(18),
                  ...
                  children: [
                    ...
                    trendAsync.when(
                      data: (list) {
                        ...
                        return Column(
                          children: [
                            _MonthlyBars(list: list),
                            const SizedBox(height: 24),
                            _MonthlyLines(list: list),
                          ],
                        );
                      },
                      loading: () => const SizedBox(
              ...
              barGroups: List.generate(finalSelected.length, (i) {
                ...
                return BarChartGroupData(
                  ...
                  barRods: [
                    BarChartRodData(
                      toY: ct.total.abs(),
                      width: 22, // Barlar biraz daha kalınlaştı
              ...
              titlesData: FlTitlesData(
                ...
                leftTitles: AxisTitles(
                  sideTitles: SideTitles(
                    showTitles: true,
                    reservedSize: 36, // Y EKSENİ KIRILMA FIX
                    getTitlesWidget: (value, meta) {
                      if (value == 0) return const SizedBox.shrink();
                      // Büyük sayıları k ile kısalt (örn: 8500 -> 8.5k)
                ...
                bottomTitles: AxisTitles(
                  sideTitles: SideTitles(
                    ...
                    reservedSize: 28,
                    getTitlesWidget: (value, meta) {
                      // ALT EKSEN 0,1,2 YERİNE KATEGORİ İSMİ FIX
...
class _MonthlyBars extends StatelessWidget {
  ...
  const _MonthlyBars({required this.list});
  ...
  Widget build(BuildContext context) {
    ...
    for (int i = 0; i < list.length; i++) {
      final it = list[i];
      final income = it.income;
      final expenseAbs = it.expense.abs();
      final total = income + expenseAbs;
            ...
            BarChartRodData(
              ...
              rodStackItems: [
                BarChartRodStackItem(
                    0, expenseAbs, Colors.red.withOpacity(0.75)),
                BarChartRodStackItem(
                    expenseAbs, total, Colors.green.withOpacity(0.75)),
              ],
            ),
          ],
        ),
        ...
        BarChartData(
          ...
          titlesData: FlTitlesData(
            bottomTitles: AxisTitles(
              sideTitles: SideTitles(
                showTitles: true,
                interval: 1, // TARİH YAZILARI İÇ İÇE GİRME FIX
                reservedSize: 28,
                getTitlesWidget: (value, meta) {
                  final idx = value.toInt();
